    ...
    return function (error, response, body) {
        ...
        default:
            try {
                const data = JSON.parse(body);
                return cb({
                    err: 'Unexpected status code of the response: ' + response.statusCode,
                    data: data
                });
            } catch (err) {
                return cb(err);
...
Freshdesk.prototype = Object.create({
     ...
     * @param  {Freshdesk.requestCallback}  cb        Callback function
    ...
    * @param  {Freshdesk.requestCallback} cb   [description]
    * @return {void}          `void`
    */
     ...
     * @param  {Freshdesk.requestCallback}   cb
     * @return {void}          `void`
     */
