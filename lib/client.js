...
class Freshdesk {
	...
	filterTickets (query, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/search/tickets?query="${encodeURI(query)}"`, null, null, cb)
	}
	...
	listAllSolutionCategories(cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/solutions/categories`, null, null, cb)
	}

	getSolutionCategory(id, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/solutions/categories/${id}`, null, null, cb)
	}
	...
	getSolutionFolder(id, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/solutions/folders/${id}`, null, null, cb)
	}
	...
	getSolutionArticle(id, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/solutions/articles/${id}`, null, null, cb)
	}

	searchSolutionArticles(term, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/search/solutions?term=${encodeURI(term)}`, null, null, cb)
	}
